...
interface EmotionDistributionChartsProps {
...
export const EmotionDistributionCharts: React.FC<EmotionDistributionChartsProps> = ({
  data,
  loading
}) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
      ...
      <div className="h-[250px] w-full">
        <p className="text-[10px] font-black uppercase tracking-widest text-(--muted-foreground) mb-4">Frequency by Emotion</p>
      ...
      <div className="h-[250px] w-full relative">
        <p className="text-[10px] font-black uppercase tracking-widest text-(--muted-foreground) mb-4">Emotional Share %</p>
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
            <Pie
              data={data}
